...
class MyTestCase(unittest.TestCase):
    ...
    def test_simple_c_cmd(self):
        platform = HackEmulator([0b1111000010011001])
        platform._D = 5;
        platform._A = 7;
    ...
    def test_add_program(self):
        platform = HackEmulator([0b0000000000000010,
                                 0b1110110000010000,
                                 0b0000000000000011,
                                 0b1110000010010000,
                                 0b0000000000000000,
    ...
    def test_max_program(self):
        platform = HackEmulator([0b0000000000000000,
                                 0b1111110000010000,
                                 0b0000000000000001,
                                 0b1111010011010000,
                                 0b0000000000001010,
    ...
    def test_basic_loop(self):
        ...
        platform = HackEmulator(loop_prog)
        platform._ram[0] = 256
        platform._ram[1] = 300
        platform._ram[2] = 400
        platform._ram[400] = 5
    ...
    def test_byte_overflow(self):
        platform = HackEmulator([0b0111111111111111,
                                 0b1110110000010000,
                                 0b0000000000000000,
                                 0b1110001100001000,
                                 0b1111000010001000,
        ...
        platform = HackEmulator([0b1110111010001000])
        platform.run()
        self.assertEqual(platform._ram[0], 0b1111111111111111)

        platform = HackEmulator([0b0000000000000100,
                                 0b1110111010000100,
                                 0b0000000000000000,
                                 0b1110101010000111,
                                 0b0000000000000000,
    ...
    def test_pong(self):
        ...
        platform = HackEmulator(pong_prog)
